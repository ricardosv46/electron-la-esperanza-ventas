...
const VentasAsientos = () => {
  ...
  return (
    <PlantillaPage title="Butacas" desc="Desde aqui podras visualizar la informacion de todas los butacas">
      ...
      <Show condition={loadingEventos} loading isDefault={<Spinner className="w-10 h-10 mx-auto my-10 border-4" />}>
          ...
          {eventos.map((evento) => {
            ...
            return (
              ...
              >
                ...
                <p className={classNames(['z-10 text-yellow-500 dark:text-primary-500'])}>{evento?.titulo}</p>
              </button>
            );
          })}
        </div>
