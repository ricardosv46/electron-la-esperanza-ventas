...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="relative flex justify-center h-full px-4 overflow-hidden md:px-0">
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-sm py-8 ">
            ...
            <div className="flex flex-col gap-10 py-10">
              ...
              <div className="flex flex-col justify-between gap-y-3 sm:flex-row">
                <CheckBox label="Recordarme" value={isChecked} onClick={() => setIsChecked(!isChecked)} />
                <p
